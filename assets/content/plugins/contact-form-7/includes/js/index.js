!function () {
    "use strict";
    const e = e => Math.abs(parseInt(e, 10)), t = (e, t) => {
        ...
        return n.reduceRight(((e, t) => a => t(a, e)), (e => {
            ...
            "string" == typeof s && (r = a.replace(/^\/|\/$/g, ""), n = s.replace(/^\//, ""), c = n ? r + "/" + n : r), "string" == typeof c && (-1 !== t.indexOf("?") && (c = c.replace("?", "&")), c = c.replace(/^\//, ""), o = t + c), i = {Accept: "application/json, */*;q=0.1", ...i}, delete i["X-WP-Nonce"], d && (l = JSON.stringify(d), i["Content-Type"] = "application/json");
    ...
    function o(e) {
        ...
        Promise.resolve(t(e, "validating")).then((t => {
            if (void 0 !== swv) {
                ...
                for (const [a, {error: r}] of t) s(e, a), void 0 !== r && c(e, a, r)
            }
        })).finally((() => {
    ...
    function f(t) {
        ...
        t.wpcf7 = {
            ...
            const a = (t, a) => {
                const r = e(t.getAttribute("data-starting-value")), n = e(t.getAttribute("data-maximum-value")),
                ...
                e = {init: !1, ...e}, t.querySelectorAll(".wpcf7-character-count").forEach((r => {
                    const n = r.getAttribute("data-target-name"), o = t.querySelector(`[name="${n}"]`);
                    o && (o.value = o.defaultValue, a(r, o), e.init && o.addEventListener("keyup", (e => {
                        a(r, o)
                    })))
                }))
            };
            r({init: !0}), t.addEventListener("wpcf7reset", (e => {
                r()
            }))
